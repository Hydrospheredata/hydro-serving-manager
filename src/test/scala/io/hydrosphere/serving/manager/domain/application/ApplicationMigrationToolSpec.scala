...
class ApplicationMigrationToolSpec extends GenericUnitTest {
  describe("ApplicationMigrationTool") {
    it("should detect and recover invalid apps") {
      ...
      val data1 = ApplicationRow(1, "test", None, "Ready", "", graph, Nil, None, Nil, Nil)
      val data2 = ApplicationRow(1, "test", None, "Ready", "", graph, Nil, None, Nil, Nil)
    ...
    it("should fill absent model versions") {
      ...
      val data1 = ApplicationRow(1, "test", None, "Ready", "", graph, Nil, None, Nil, Nil)
      val data2 = ApplicationRow(2, "test", None, "Ready", "", graph, Nil, None, Nil, Nil)
