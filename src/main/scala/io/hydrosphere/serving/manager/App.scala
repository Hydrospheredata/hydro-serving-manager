...
import io.hydrosphere.serving.manager.api.http.controller.{DeploymentConfigController, HostSelectorController, MonitoringController}
...
import io.hydrosphere.serving.manager.domain.deploy_config.{DeploymentConfigurationEvents, DeploymentConfigurationRepository}
